...
CONSULTAS_TIPO_A = [
    ...
    {"id": "A6", "consulta": "Qual o valor total das emendas de comissão em Santa Catarina em 2023?",
     "esperado": {"uf": "SC", "ano": 2023, "tipo_emenda": "comissao", "operacao": "soma"}},
    ...
    {"id": "A19", "consulta": "Qual o total empenhado em emendas de relator em Minas Gerais em 2020?",
     "esperado": {"uf": "MG", "ano": 2020, "tipo_emenda": "relator", "operacao": "soma"}},
    ...
    {"id": "A23", "consulta": "Quais parlamentares do PL tiveram emendas no Amapá em 2024?",
     "esperado": {"partido": "PL", "uf": "AP", "ano": 2024}},
    ...
    {"id": "A25", "consulta": "Quantas emendas de comissão existem no Maranhão em 2023?",
     "esperado": {"uf": "MA", "ano": 2023, "tipo_emenda": "comissao", "operacao": "contagem"}},
...
# Requerem mapeamento de área temática via dicionário e/ou busca em documentos de despesa
# ============================================
CONSULTAS_TIPO_B = [
    {"id": "B1", "consulta": "Quais emendas para saúde foram executadas no Distrito Federal em 2023?",
     "esperado": {"area": "saude", "uf": "DF", "ano": 2023}},
    {"id": "B2", "consulta": "Quais emendas financiaram construção de pontes no Pará?",
     "esperado": {"area": "transporte", "uf": "PA", "busca_documentos": True}},
    {"id": "B3", "consulta": "Emendas que custearam reforma de escolas em Minas Gerais em 2023?",
     "esperado": {"area": "educacao", "uf": "MG", "ano": 2023, "busca_documentos": True}},
    {"id": "B4", "consulta": "Quais emendas para transporte foram pagas na Bahia?",
     "esperado": {"area": "transporte", "uf": "BA"}},
    {"id": "B5", "consulta": "Quais emendas financiaram aquisição de equipamentos hospitalares na Bahia?",
     "esperado": {"area": "saude", "uf": "BA", "busca_documentos": True}},
    ...
    {"id": "B7", "consulta": "Emendas para pavimentação de rodovias no Tocantins em 2024?",
     "esperado": {"area": "transporte", "uf": "TO", "ano": 2024, "busca_documentos": True}},
    {"id": "B8", "consulta": "Quais parlamentares destinaram emendas para agricultura no Paraná?",
     "esperado": {"area": "agricultura", "uf": "PR"}},
    {"id": "B9", "consulta": "Quais emendas custearam construção de UBS no Ceará em 2024?",
     "esperado": {"area": "saude", "uf": "CE", "ano": 2024, "busca_documentos": True}},
    {"id": "B10", "consulta": "Emendas para desporto e lazer no Ceará em 2023?",
     "esperado": {"area": "desporto e lazer", "uf": "CE", "ano": 2023}},
    {"id": "B11", "consulta": "Emendas que mencionam saneamento e esgoto no Maranhão em 2023?",
     "esperado": {"area": "saneamento", "uf": "MA", "ano": 2023, "busca_documentos": True}},
    {"id": "B12", "consulta": "Quais emendas para agricultura foram pagas em Roraima em 2023?",
     "esperado": {"area": "agricultura", "uf": "RR", "ano": 2023}},
    {"id": "B13", "consulta": "Quais emendas financiaram compra de ambulâncias no Rio Grande do Sul?",
     "esperado": {"area": "saude", "uf": "RS", "busca_documentos": True}},
    {"id": "B14", "consulta": "Emendas para trabalho e emprego no Rio Grande do Sul em 2023?",
     "esperado": {"area": "trabalho", "uf": "RS", "ano": 2023}},
    {"id": "B15", "consulta": "Emendas de educação que mencionam creche em São Paulo em 2024?",
     "esperado": {"area": "educacao", "uf": "SP", "ano": 2024, "busca_documentos": True}},
    {"id": "B16", "consulta": "Quais emendas de saúde foram pagas na Bahia em 2024?",
     "esperado": {"area": "saude", "uf": "BA", "ano": 2024}},
    {"id": "B17", "consulta": "Quais emendas financiaram aquisição de tratores e escavadeiras em Goiás?",
     "esperado": {"area": "agricultura", "uf": "GO", "busca_documentos": True}},
    {"id": "B18", "consulta": "Emendas para urbanismo em Goiás em 2024?",
     "esperado": {"area": "urbanismo", "uf": "GO", "ano": 2024}},
    {"id": "B19", "consulta": "Quais obras de infraestrutura foram financiadas por emendas em Rondônia em 2024?",
     "esperado": {"area": "urbanismo", "uf": "RO", "ano": 2024, "busca_documentos": True}},
    {"id": "B20", "consulta": "Emendas para cultura em Pernambuco em 2023?",
     "esperado": {"area": "cultura", "uf": "PE", "ano": 2023}},
    {"id": "B21", "consulta": "Quanto o PL investiu em educação no Mato Grosso do Sul em 2020?",
     "esperado": {"partido": "PL", "area": "educacao", "uf": "MS", "ano": 2020, "operacao": "soma"}},
    {"id": "B22", "consulta": "Emendas para direitos da cidadania na Paraíba em 2023?",
     "esperado": {"area": "direitos da cidadania", "uf": "PB", "ano": 2023}},
    {"id": "B23", "consulta": "Qual deputado do MDB mais investiu em saúde no Mato Grosso em 2021?",
     "esperado": {"partido": "MDB", "area": "saude", "uf": "MT", "ano": 2021, "operacao": "ranking"}},
    ...
    {"id": "B28", "consulta": "Qual deputado mais investiu em agricultura em Alagoas em 2023?",
     "esperado": {"area": "agricultura", "uf": "AL", "ano": 2023, "operacao": "ranking"}},
...
CONSULTAS_TIPO_D = [
    ...
    {"id": "D14", "consulta": "Quais entidades receberam emendas de saúde no Pará em 2023?",
     "esperado": {"area": "saude", "uf": "PA", "ano": 2023, "busca_beneficiario": True}},
    ...
    {"id": "D18", "consulta": "Quais entidades receberam emendas de saúde no Mato Grosso do Sul em 2024?",
     "esperado": {"area": "saude", "uf": "MS", "ano": 2024, "busca_beneficiario": True}},
    {"id": "D19", "consulta": "Quais entidades de assistência social receberam emendas na Bahia em 2022?",
     "esperado": {"area": "assistencia social", "uf": "BA", "ano": 2022, "busca_beneficiario": True}},
    ...
    {"id": "D23", "consulta": "O MDB destinou emendas para quais entidades de saúde no Mato Grosso em 2021?",
     "esperado": {"partido": "MDB", "uf": "MT", "ano": 2021, "busca_beneficiario": True}},
    ...
    {"id": "D26", "consulta": "Quais prefeituras receberam emendas do PL para saúde na Bahia em 2024?",
     "esperado": {"partido": "PL", "area": "saude", "uf": "BA", "ano": 2024, "busca_beneficiario": True}},
